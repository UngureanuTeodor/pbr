...
(defrule afisareBoard
	...
	(printout t crlf "Score: " ?xxxxxx crlf crlf)
...
(defrule stergePozitieVechePiesa (declare (salience 15))
	?a1 <- (x0 ?x0)
	?a2 <- (x1 ?x1)
	?a3 <- (x2 ?x2)
	?b1 <- (y0 ?y0)
...
(defrule checkEndingLFF3
	...
	(and (test (eq ?valoare00 0)) (test (eq ?valoare10 1)))
	(x0 ?x0)
	(y0 ?y0)
	(y1 ?y1)
	(y2 ?y2)
...
(defrule checkEndingLFE2
	...
	(and (test (eq ?valoare01 0)) (test (eq ?valoare11 1)))
	(x0 ?x0)
	(y0 ?y0)
	(y1 ?y1)
	(y2 ?y2)
	(x0_1 ?x0_1)
	(board (i ?x0) (j ?y1) (val ?p1))
	(test (eq ?p1 1))
	=>
	(assert (lastmove 1))
)

(defrule checkEndingLFR1
	?a <- (checkEnding 1)
	(piesa 
		(numarOrdine 0)
		(casuta1DinPiesa 0 0 ?valoare00)
	...
	(and (test (eq ?valoare02 0)) (test (eq ?valoare12 1)))
	(x0 ?x0)
	(y0 ?y0)
	(y1 ?y1)
	(y2 ?y2)
	(x0_1 ?x0_1)
	(board (i ?x0) (j ?y2) (val ?p1))
	(test (eq ?p1 1))
	=>
	(assert (lastmove 1))
)

(defrule checkEndingLFFSs
	?a <- (checkEnding 1)
	(piesa 
		(numarOrdine 0)
		(casuta1DinPiesa 0 0 ?valoare00)
	...
	(and (test (eq ?valoare10 0)) (test (eq ?valoare20 1)))
	(x0 ?x0)
	(x1 ?x1)
	(y0 ?y0)
	(y1 ?y1)
...
(defrule checkEndingLFESss
	...
	(and (test (eq ?valoare11 0)) (test (eq ?valoare21 1)))
	(x0 ?x0)
	(x1 ?x1)
	(y0 ?y0)
	(y1 ?y1)
	(y2 ?y2)
	(x0_1 ?x0_1)
	(board (i ?x1) (j ?y1) (val ?p1))
	(test (eq ?p1 1))
	=>
	(assert (lastmove 1))
)

(defrule checkEndingLFRS
	?a <- (checkEnding 1)
	(piesa 
		(numarOrdine 0)
		(casuta1DinPiesa 0 0 ?valoare00)
	...
	(and (test (eq ?valoare12 0)) (test (eq ?valoare22 1)))
	(x0 ?x0)
	(x1 ?x1)
	(y0 ?y0)
	(y1 ?y1)
...
(defrule end_game (declare (salience 10))
	?o <- (optiune 1)
	?l <- (lastmove 1)
	(board (i 20) (j 1) (val ?v1))
	(board (i 20) (j 2) (val ?v2))
	(board (i 20) (j 3) (val ?v3))
	(board (i 20) (j 4) (val ?v4))
	(board (i 20) (j 5) (val ?v5))
	(board (i 20) (j 6) (val ?v6))
	(board (i 20) (j 7) (val ?v7))
	(board (i 20) (j 8) (val ?v8))
	(board (i 20) (j 9) (val ?v9))
	(board (i 20) (j 10) (val ?v10))
	(or 	(test(neq ?v1 0))
			(test(neq ?v2 0))
			(test(neq ?v3 0))
			(test(neq ?v4 0))
...
(defrule miscare2
	...
	(assert (moveList r a s s s s s s s s s s s s s s s s s s s s s s))
)
...
(defrule miscare4
	...
	(assert (moveList d s s s s s s s s s s s s s s s s s s s s s s))
)
