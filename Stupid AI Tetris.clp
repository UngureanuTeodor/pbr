...
(deffacts initializareBoard
	...
	(board (i 8) (j 0) (val 1))
	(board (i 9) (j 0) (val 1))
	(board (i 10) (j 0) (val 1))
	(board (i 11) (j 0) (val 1))
	(board (i 12) (j 0) (val 1))
	(board (i 13) (j 0) (val 1))
	(board (i 14) (j 0) (val 1))
	(board (i 15) (j 0) (val 1))
	(board (i 16) (j 0) (val 1))
	(board (i 17) (j 0) (val 1))
	(board (i 18) (j 0) (val 1))
	(board (i 19) (j 0) (val 1))
	(board (i 20) (j 0) (val 1))
	
	;limitaDreapta
	(board (i 0) (j 11) (val 1))
	(board (i 1) (j 11) (val 1))
	(board (i 2) (j 11) (val 1))
	(board (i 3) (j 11) (val 1))
	(board (i 4) (j 11) (val 1))
	(board (i 5) (j 11) (val 1))
	(board (i 6) (j 11) (val 1))
	(board (i 7) (j 11) (val 1))
	(board (i 8) (j 11) (val 1))
	(board (i 9) (j 11) (val 1))
	(board (i 10) (j 11) (val 1))
	(board (i 11) (j 11) (val 1))
	(board (i 12) (j 11) (val 1))
	(board (i 13) (j 11) (val 1))
	(board (i 14) (j 11) (val 1))
	(board (i 15) (j 11) (val 1))
	(board (i 16) (j 11) (val 1))
	(board (i 17) (j 11) (val 1))
	(board (i 18) (j 11) (val 1))
	(board (i 19) (j 11) (val 1))
	(board (i 20) (j 11) (val 1))
...
(defrule piesaUrmatoare (declare (salience 3))
	(optiune 1)
	?b <- (random ?rnd)
	(numarPiese ?np)
	?a <- (lastmove 1)
...
(defrule mutare_stanga (declare (salience 1))
	...
	(not (or
		...
		(and (test(< 1 (+ ?val00 ?val00next))))
		(and (test(< 1 (+ ?val01 ?val01next))))
		(and (test(< 1 (+ ?val02 ?val02next))))
		(and (test(< 1 (+ ?val10 ?val10next))))
		(and (test(< 1 (+ ?val20 ?val20next))))
	))
	=>
	(retract ?a)
...
(defrule mutareStanga_stergePozitieVechePiesa
	...
	(assert (x1 (- ?x1 1)))
	(assert (x2 (- ?x2 1)))
	(assert (x0next (- ?x0next 1)))
	(assert (x1next (- ?x1next 1)))
	(assert (x2next (- ?x2next 1)))
	(assert (y0 (- ?y0 1)))
	(assert (y1 (- ?y1 1)))
	(assert (y2 (- ?y2 1)))
	(assert (y0next (- ?y0next 1)))
	(assert (y1next (- ?y1next 1)))
	(assert (y2next (- ?y2next 1)))
	(assert (introducerePieseCurenta))
)

; *********************** Mutare piesa dreapta
(defrule mutare_dreapta_initial (declare (salience 2))
	(literaCitita d)
	?a <- (initializareNexturi)
	(x0 ?x0)
	(x1 ?x1)
...
(defrule mutare_dreapta (declare (salience 1))
	?a <- (literaCitita d)
	?b <- (piesa
		(numarOrdine -1)
	)
...
(defrule end_game (declare (salience 10))
	?o <- (optiune 1)
	?l <- (lastmove 1)
	(board (i 19) (j 1) (val ?v1))
	(board (i 19) (j 2) (val ?v2))
	(board (i 19) (j 3) (val ?v3))
	(board (i 19) (j 4) (val ?v4))
	(board (i 19) (j 5) (val ?v5))
	(board (i 19) (j 6) (val ?v6))
	(board (i 19) (j 7) (val ?v7))
	(board (i 19) (j 8) (val ?v8))
	(board (i 19) (j 9) (val ?v9))
	(board (i 19) (j 10) (val ?v10))
	(or 	(test(neq ?v1 0))
			(test(neq ?v2 0))
			(test(neq ?v3 0))
			(test(neq ?v4 0))
