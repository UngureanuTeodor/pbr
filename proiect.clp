...
(defrule checkEnding1
	...
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
	(or (test (eq ?p1 1)) (test (eq ?p2 1)) (test (eq ?p3 1)))
	=>
	(assert (lastmove 1))
)

(defrule checkEnding2
	?a <- (checkEnding 1)
	(x0 ?x0)
	(x1 ?x1)
	(x2 ?x2)
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 1)) (test (eq ?p2 1)) (test (eq ?p3 0)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
...
(defrule checkEnding3
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 1)) (test (eq ?p2 0)) (test (eq ?p3 1)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
	(or (test (eq ?p1 1)) (test (eq ?p3 1)))
	=>
	(assert (lastmove 1))
)

(defrule checkEnding4
	?a <- (checkEnding 1)
	(x0 ?x0)
	(x1 ?x1)
	(x2 ?x2)
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 0)) (test (eq ?p2 1)) (test (eq ?p3 1)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
...
(defrule checkEnding5
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 1)) (test (eq ?p2 0)) (test (eq ?p3 0)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
...
(defrule checkEnding7
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 0)) (test (eq ?p2 1)) (test (eq ?p3 0)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
...
(defrule checkEnding8
	...
	(board (i ?x0) (j ?y1) (val ?p2))
	(board (i ?x0) (j ?y2) (val ?p3))
	(and (test (eq ?p1 0)) (test (eq ?p2 0)) (test (eq ?p3 1)))
	?x0_1 <- (- ?x0 1)
	(board (i ?x0_1) (j ?y0) (val ?p_1))
	(board (i ?x0_1) (j ?y1) (val ?p_2))
	(board (i ?x0_1) (j ?y2) (val ?p_3))
